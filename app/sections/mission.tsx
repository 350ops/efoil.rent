        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          className=" order-1 lg:order-2">
            <div className="inline-block px-4 py-1.5 bg-highlight rounded-full">
              <span className="text-xs uppercase font-bold text-black">Our Mission</span>
            </div>
            ...
            <p className="text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed mb-8">
              We believe in creating tools that empower users to achieve more with less effort.
              Our platform combines powerful functionality with an intuitive design that anyone can master.
            </p>

            <div className="space-y-4">
              {[
                "Lightning-fast performance with optimized technology",
