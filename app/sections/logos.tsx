...
export function Logos() {
    const logos = [
        { src: "/img/logo-1.svg", alt: "Company Logo 1" },
        { src: "/img/logo-2.svg", alt: "Company Logo 2" },
        { src: "/img/logo-3.svg", alt: "Company Logo 3" },
        { src: "/img/logo-4.svg", alt: "Company Logo 4" },
        { src: "/img/logo-5.svg", alt: "Company Logo 5" },
    ];
