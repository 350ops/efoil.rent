          ...
          <motion.div
            ...
            className="bg-white dark:bg-neutral-950 p-6 md:p-12 rounded-4xl w-full md:w-1/2 flex flex-col">
              ...
              <form className="space-y-4">
                ...
                <div className="flex items-center gap-2">
                  <input
                    type="checkbox"
                    id="remember"
                    className="w-4 h-4 rounded border-zinc-300 dark:border-zinc-600 text-highlight focus:ring-highlight"
                  />
                ...
                <button
                  type="submit"
                  className="w-full cursor-pointer text-black px-6 py-3 bg-highlight hover:bg-highlight-hover text-highlight-text rounded-xl font-semibold transition-colors"
                >
                  Sign In
                </button>
              </form>
              ...
              <p className="text-center text-sm text-zinc-600 dark:text-zinc-400 mt-6">
                ...
                <a href="/signup" className="text-zinc-900 dark:text-white font-semibold hover:underline">
                  Sign up
                </a>
              </p>
          </motion.div>
